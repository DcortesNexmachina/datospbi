...
class CustomerFlowAnalysis:
    ...
    def create_visualizations(self, output_dir: Path, df_store) -> None:
        ...
        period1_end = datetime(2024, 12, 20)
        period2_start = datetime(2024, 12, 21)
        period2_end = datetime(2025, 1, 6)

        plt.figure(figsize=(12, 6))
        self.df.set_index('Fecha')['Entradas'].plot()
        plt.axvspan(period2_start, period2_end, color='blue', alpha=0.3, label='Durante Navidad')
    ...
    def generate_html_report(self, stats: Dict, output_dir: Path, campaign_name: str) -> None:
        ...
        <body>
            ...
            <div class="narrative">
                ...
                <ul>
                    <li><strong>Antes de la campaña de Navidad</strong> (periodo inicial)</li>
                    <li><strong>Durante la campaña de Navidad</strong> (cuando la campaña estuvo activa)</li>
                </ul>
                ...
                <p>
                    ...
                    hubo mayor variabilidad en el número de entradas durante la campaña.
                    {% else %}
...
<p>
    ...
    {% endif %}
                ...
                <div class="visualization">
                    ...
                    indicando el periodo durante la campaña de Navidad.</p>
                </div>
            </div>
        </body>
        </html>
...
def main():
    try:
        ...
        base_output_dir = Path('informes_comercios_navidad')
